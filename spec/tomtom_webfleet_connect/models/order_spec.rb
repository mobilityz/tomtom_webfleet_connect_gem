...
describe TomtomWebfleetConnect::Models::Order do
  ...
  let(:client) { TomtomWebfleetConnect::API.new(ENV['API_KEY'], ENV['ACCOUNT'], {lang: "fr", use_ISO8601: true, use_UTF8: true, response_format: TomtomWebfleetConnect::TomtomResponse::FORMATS::CSV}) }
